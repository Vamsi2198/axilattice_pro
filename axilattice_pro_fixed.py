"""
AxiLattice Pro — Fixed Production Version
Live Voice I/O | Multi-Dimensional | Handles Unnamed Columns
"""
...
with st.sidebar:
    ...
    st.caption("Live Voice | Multi-Dimensional | Fixed")
...
st.divider()
st.caption("AxiLattice Pro | Live Voice | Multi-Dimensional | 21 Insight Types | Production-Ready")
